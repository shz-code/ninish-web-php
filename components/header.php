...
<header class="header fixed w-full border-b z-50 py-2">
    ...
    <div class="containerNinish mx-auto px-2 flex gap-4 justify-between items-center">
        <!-- Ham Button -->
        ...
        <!-- Result -->
        <!-- <a href="./assets/result.pdf" download class="rounded-full bg-gradient-to-tr from-violet-700 via-red-500
            to-yellow-500 text-white px-4 py-2 text-xl background-animate text-center" target="_blank">
            ফলাফল ডাউনলোড করুন
        </a> -->
        <!-- Quiz -->
        <!--<a href="https://quiz.ninish.com" class="rounded-full bg-gradient-to-tr from-violet-700 via-red-500-->
        <!--    to-yellow-500 text-white px-4 py-2 text-xl background-animate" target="_blank">-->
        <!--    কুইজে অংশগ্রহণ করুন-->
        <!--</a>-->
